...
int TestDiskDecrypt(int argc, char *argv[])
{
...
#else
	{
		...
		uint8_t key_hfs_1[0x10] = { 0x8A, 0xB0, 0x37, 0x0B, 0xB7, 0x9B, 0x4D, 0x64, 0xB3, 0x04, 0x66, 0xB5, 0x61, 0xEB, 0x0F, 0x94 }; // UUID 1
		uint8_t key_hfs_2[0x10] = { 0xAD, 0x4C, 0xE6, 0x5A, 0x1E, 0x64, 0x43, 0x40, 0x9C, 0x1A, 0x21, 0xFD, 0xED, 0xEB, 0x41, 0x89 }; // UUID 2
		uint8_t key_hfs_3[0x10] = { 0x0C, 0x56, 0xCE, 0x0B, 0x8F, 0xE9, 0xCE, 0xB6, 0xB5, 0x13, 0xAE, 0xB2, 0xFD, 0xA3, 0x65, 0x4B }; // ?

		// aes.SetKey(key, key + 0x10);
		aes.SetKey(key_hfs_3, key_hfs_3);
	}
#endif
